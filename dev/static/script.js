...
@media (max-width: 768px) and (orientation: portrait) {
    ...
    .banner-icons.left a.tooltip-link.expanded img { transform: translateY(-8px) scale(1.4) rotate(-8deg) !important; position: relative; z-index: 100; }
    .banner-icons.right a.tooltip-link.expanded img { transform: translateY(-8px) scale(1.4) rotate(8deg) !important; position: relative; z-index: 100; }
...
table.dataTable tbody tr.tier-header-row td { 
...
table.dataTable tbody tr.tier-header-row:hover td { 
    background: var(--dt-header-bg) !important; 
}

tr.tier-header-row td.dtr-control::before {
    display: none !important;
}

tr.tier-header-row td.dtr-control {
    cursor: default !important;
}
...
body[data-page="cache"].watcher-found .enigma {
    display: none;
}
...
body.ciphers-found .artist-story-purple {
    display: block;
    opacity: 1;
...
body[data-page="cache"].watcher-found .screen-deco img {
    opacity: 1;
    pointer-events: auto;
}
