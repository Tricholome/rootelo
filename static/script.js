...
document.addEventListener('DOMContentLoaded', function() {
	...
	const tierTexts = {
		...
		'stag': {
			...
			elo: '1600+',
			subtitle: 'The Legend',
			desc: 'Has anyone truly seen this mythical beast, or is it only a rumor of the wild? What happens to the predator when the woods turn hollow and each path leads back to a mirror of its own perfection? And when nothing remains to be claimed, is the true crown the silence that follows the chase?'
		}
	};
