...
def generate_page_html(title, page_heading, current_page, content, subtitle="", page_description="", custom_css="", custom_js="", extra_head=""):
    ...
    base_css = """
        ...
        .site-header { margin-bottom: 40px; padding-top: 20px; }
        .banner-container { display: flex; align-items: center; justify-content: center; gap: 35px; }
        ...
        .banner-icons img { 
            ...
            transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); /* Effet rebondi */
            cursor: help;
        }

        /* L'effet "Gros Plan" au survol */
        ...
        .site-title { color: #4a90e2; font-size: 3.2em; margin: 0; letter-spacing: 5px; text-transform: uppercase; font-weight: 900; }
        .site-subtitle { font-family: "Luminari", serif; color: #d4a76a; font-size: 1.2em; margin: 8px 0 0; letter-spacing: 1.5px; }
        ...
        <div class="site-header">
            <div class="banner-container">
                <div class="banner-icons left">
                    <img src="assets/icons/bird.png" alt="Bird">
                    <img src="assets/icons/fox.png" alt="Fox">
                </div>
                ...
                <div class="banner-icons right">
                    <img src="assets/icons/rabbit.png" alt="Rabbit">
                    <img src="assets/icons/mouse_2.webp" alt="Mouse">
                </div>
            </div>
        </div>
